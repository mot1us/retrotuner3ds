...
#---------------------------------------------------------------------------------
TARGET		:=	retrotuner3ds
BUILD		:=	build
SOURCES		:=	source source/miniiptv source/system source/system/util source/system/draw
DATA		:=	data
...
APP_DESCRIPTION		:= Live HLS television for New Nintendo 3DS
APP_AUTHOR			:= RetroTuner3DS contributors / Core_2_Extreme
