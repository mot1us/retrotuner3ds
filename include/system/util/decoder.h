...
/** Return the raw FFmpeg result from the last open/stream-info operation. */
...
/**
 * @brief Release the persistent MVD packet scratch buffer.
 * Call only after all decoder threads have stopped.
...
#define Util_decoder_get_last_open_ffmpeg_result(...) 0
...
#define Util_decoder_mvd_release_packet_buffer(...)
